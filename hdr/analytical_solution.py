...
def LineAnalyticalMSD(D, L, t_array, n_terms=100):
    """
    ...
    """
    p_range = list(range(1, n_terms))  # Roots of derivative of Bessel function J1
...
def CylinderAnalyticalMSD(D, a, L, t_array, M=100, P=100):
    ...
    for m in range(M):
        ...
        for p in range(P):
            ...
            msd += (1 / (np.pi * a**2 * L)) * exp_term * total_coeff

    return const_term + msd
